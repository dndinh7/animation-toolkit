...
public:
   ...
   void scene()
   {
      ...
      // Question 1 - B2
      vec3 d20 = vec3(4, 0, 2);
      quat R20 = glm::angleAxis(glm::pi<float>()/4, vec3(0, 0, 1));
      ...
      // Question 1 - B3
      vec3 d30 = vec3(5, 4, 2);
      quat R30 = glm::angleAxis(glm::pi<float>() / 2, vec3(0, 0, 1));
      ...
      vec3 value = F21.transformPoint(vec3(3, 4, 1));
      ...
      value = F32.transformPoint(vec3(2, 3, 1));
      ...
      vec3 d40 = vec3(-2, 2, 1);
      quat R40 = glm::angleAxis(0.f, vec3(0, 0, 1));
      Transform F(R40, d40);
